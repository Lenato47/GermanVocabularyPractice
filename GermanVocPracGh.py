from Vokabellisten import vokabeldeutschspanischextern,vokabelspanischextern, vokabelenglischextern,vokabeldeutschenglischextern, vokabelfranzoesisch, vokabeldeutschfranz
import random
...
class Ui_FirstWindow(object):
    ...
    def setupUi(self, FirstWindow):
        ...
        self.label_3.setGeometry(QtCore.QRect(190, 50, 220, 50))
        self.label_3.setFont(QFont('Arial', 15))
        self.label_3.setText("Idioma/Language/Langue")
    ...
    def retranslateUi(self, FirstWindow):
        ...
        FirstWindow.setWindowTitle(_translate("FirstWindow", "practicar alemán / practice german / pratiquer l'allemand"))
        self.pushButton.setText(_translate("Firstbutton", "español/alemán"))
        self.pushButton_2.setText(_translate("Secondbutton", "englisch/german"))
        self.pushButton_3.setText(_translate("Thirdbutton", "français/allemand"))
...
class Ui_Spanishwindow(object):
    ...
    def startbutton(self):
        randomvocesp = random.choice(vokabeldeutschspanischextern)
        index = vokabeldeutschspanischextern.index(randomvocesp)
        indexdeutsch = vokabelspanischextern[index]
    ...
    def nextbutton(self):
        randomvocesp = random.choice(vokabeldeutschspanischextern)
        index = vokabeldeutschspanischextern.index(randomvocesp)
        indexdeutsch1 = vokabelspanischextern[index]
        self.lineEdit.setText(randomvocesp)
    ...
    def setupUi(self, Button1):
        ...
        self.labelspanien.setPixmap(QtGui.QPixmap("Deutsch.jpg"))
        ...
        self.labeldeutschland.setPixmap(QtGui.QPixmap("Spanien.jpg"))
        ...
        self.lineEdit_3.setPlaceholderText("Traducción")
        ...
        self.startButton.setText("Empezar")
        ...
        self.pushButton2.setText("siguiente")
    ...
    def retranslateUi(self, Button1):
        ...
        self.pushButton.setText(_translate("Button1", "solución (Enter)"))
...
class Ui_EnglishWindow(object):
    ...
    def startbutton(self):
        randomvoceng = random.choice(vokabeldeutschenglischextern)
        indexeng = vokabeldeutschenglischextern.index(randomvoceng)
        indexdeutscheng = vokabelenglischextern[indexeng]
    ...
    def nextbutton(self):
        randomvoceng = random.choice(vokabeldeutschenglischextern)
        indexeng = vokabeldeutschenglischextern.index(randomvoceng)
        indexdeutscheng1 = vokabelenglischextern[indexeng]
        self.lineEdit.setText(randomvoceng)
    ...
    def setupUi(self, Button1):
        ...
        self.labelengland.setPixmap(QtGui.QPixmap("Deutsch.jpg"))
        ...
        self.labeldeutschland.setGeometry(QtCore.QRect(440, 70, 271, 131))
        self.labeldeutschland.setText("")
        self.labeldeutschland.setPixmap(QtGui.QPixmap("England.jpg"))
        self.labeldeutschland.setScaledContents(True)
        self.labeldeutschland.setObjectName("labeldeutschland")
        ...
        self.lineEdit_3.setGeometry(QtCore.QRect(102, 289, 271, 41))
        self.lineEdit_3.setObjectName("Inputfeld")
        self.lineEdit_3.setPlaceholderText("Translation")
        self.lineEdit_3.returnPressed.connect(self.aufloesungsbutton)
    ...
    def retranslateUi(self, Button1):
        ...
        self.pushButton.setText(_translate("Button1", "Solution (Enter)"))
...
class Ui_frenchWindow(object):
    ...
    def startbutton(self):
        randomvocfr = random.choice(vokabeldeutschfranz)
        indexfr = vokabeldeutschfranz.index(randomvocfr)
        indexdeutschfr = vokabelfranzoesisch[indexfr]
    ...
    def nextbutton(self):
        randomvocfr = random.choice(vokabeldeutschfranz)
        indexfr = vokabeldeutschfranz.index(randomvocfr)
        indexdeutschfr1 = vokabelfranzoesisch[indexfr]
        self.lineEdit.setText(randomvocfr)
    ...
    def setupUi(self, Button1):
        ...
        self.labeldeutschland.setGeometry(QtCore.QRect(440, 70, 271, 131))
        self.labeldeutschland.setText("")
        self.labeldeutschland.setPixmap(QtGui.QPixmap("Frankreich.jpg"))
        self.labeldeutschland.setScaledContents(True)
        self.labeldeutschland.setObjectName("labeldeutschland")
        ...
        self.pushButton2.setGeometry(QtCore.QRect(180, 350, 120, 41))
        self.pushButton2.setObjectName("Nextbutton (space)")
        self.pushButton2.setText("prochain")
        self.pushButton2.clicked.connect(self.nextbutton)
